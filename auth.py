...
def main():
    ...
    with col1:
        ...
        if uploaded_file is not None:
            ...
            if best_score == 0:
                st.warning("No match found in fingerprint recognition. Please reupload a valid fingerprint image.")
                return  # Stop processing if no match is found
            else:
        ...
        if not cap.isOpened():
            ...
            if capture_button:
                ...
                if ret:
                    ...
                    # Perform face recognition only if fingerprint matching is successful
                    if fingerprint_done:
